...
function copyGraphs(originalGraphs: Record<GraphPlacement, GraphType>, selectedGraph: GraphPlacement, newGraphType: GraphType): Record<GraphPlacement, GraphType> {
    let copy = Object.assign({}, originalGraphs)
